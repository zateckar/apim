...
export const ATTENTION_LABEL: Record<AttentionCode, { title: string; action: string }> = {
  ...
  "release-stale": { title: "Overtaken by later release", action: "Review and release again" },
  ...
  "key-ageing": { title: "Key is ageing", action: "Rotate the key" },
  "key-expired": { title: "Key has expired", action: "Rotate the key" },
  ...
  "job-retrying": { title: "Background job retrying", action: "See jobs" },
